        ...
        <div key={index}>
          ...
          >
            {skill.items.map((item, index) => (
              <li
                key={index}
                className="bg-sapphireSky hover:shadow-custom-glow flex h-32 w-24 transform flex-col justify-center rounded-xl text-center transition duration-300 ease-in-out hover:-translate-x-1 hover:-translate-y-1"
              >
                <img
                  src={item.img}
                  alt={item.name}
